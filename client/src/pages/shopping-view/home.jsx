...
import { TbCircleLetterL, TbCircleLetterH } from "react-icons/tb";
...
const brandsWithIcon = [
  ...
  { id: "levi", label: "Levi's", icon: TbCircleLetterL },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {categoriesWithIcon.map((categoryItem) => (
              ...
              >
                <CardContent className="flex flex-col items-center justify-center p-6 bg-black text-white rounded hover:p-4">
            ...
            {brandsWithIcon.map((brandItem) => (
              ...
              >
                <CardContent className="flex flex-col items-center justify-center p-6 bg-black text-white rounded hover:p-4">
                  ...
                  <span className="font-bold hover:">{brandItem.label}</span>
                </CardContent>
              </Card>
            ))}
          </div>
